...
1) Download and install Mongo DB (https://docs.mongodb.com/manual/installation/)
2) In order to run mongodb from anywhere in the cmd, you need to add it to your path variables: 
  Windows : Follow the steps in this link: https://codinglead.github.io/javascript/setting-environment-variables-in-windows-10
  Linux :    Add the below line to your bashrc file
  export PATH="/home/..../mongodb/mongodb-linux-x86_64-2.4.9/bin:$PATH"
3) Restart the console  
4) Run 
Windows : ./start_database.sh
Linux: chmod +x start_database.sh
        ./start_database.sh


Use your command line or GUI to start writing commands

To list the existing databases:

show dbs

To Create Planners app database : 

use plannersApp

Check out this link for more Documentation: https://docs.mongodb.com/manual/introduction/


NOTE: VS code's MongoDB extensions is quite good
